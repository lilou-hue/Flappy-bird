...
(() => {
  ...
  const TEMPLATES = {
    'circle':      [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.15, 0.85, 0.28, 1.00, 1.00, 0.95, 0.95, 0.95, 1, 1, 0.00, 0.50, 0.50],
    'square':      [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.10, 0.90, 0.30, 1.00, 0.78, 1.00, 0.95, 0.95, 1, 1, 0.00, 0.50, 0.50],
    'triangle':    [0.35, 0.35, 0.15, 0.15, 0.50, 0.35, 0.20, 0.80, 0.20, 0.90, 0.60, 0.95, 0.85, 0.40, 1, 0, 0.05, 0.50, 0.40],
    'star':        [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.30, 0.70, 0.22, 1.00, 0.50, 0.60, 0.90, 0.90, 1, 0, 0.10, 0.50, 0.50],
    'line':        [0.30, 0.30, 0.20, 0.20, 0.50, 0.45, 0.40, 0.60, 0.05, 0.20, 0.00, 1.00, 0.40, 0.40, 1, 0, 1.00, 0.50, 0.45],
    'cross':       [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.50, 0.50, 0.15, 1.00, 0.30, 0.70, 0.95, 0.95, 2, 0, 0.80, 0.50, 0.50],
    'heart':       [0.30, 0.30, 0.20, 0.20, 0.50, 0.40, 0.25, 0.75, 0.25, 0.95, 0.65, 0.80, 0.90, 0.50, 1, 0, 0.05, 0.50, 0.45],
    'diamond':     [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.35, 0.65, 0.18, 0.80, 0.65, 0.90, 0.95, 0.95, 1, 0, 0.00, 0.50, 0.50],
    'sun':         [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.30, 0.70, 0.25, 1.00, 0.55, 0.60, 0.85, 0.85, 1, 1, 0.30, 0.50, 0.50],
    'moon':        [0.35, 0.15, 0.35, 0.15, 0.35, 0.50, 0.20, 0.80, 0.18, 0.85, 0.70, 0.85, 0.30, 0.85, 1, 0, 0.00, 0.40, 0.50],
    'house':       [0.30, 0.30, 0.20, 0.20, 0.50, 0.40, 0.20, 0.80, 0.22, 0.85, 0.35, 0.90, 0.85, 0.40, 2, 0, 0.10, 0.50, 0.45],
    'tree':        [0.25, 0.25, 0.25, 0.25, 0.50, 0.40, 0.30, 0.70, 0.20, 0.65, 0.40, 0.75, 0.80, 0.35, 2, 0, 0.05, 0.50, 0.42],
    'flower':      [0.25, 0.25, 0.25, 0.25, 0.50, 0.45, 0.30, 0.70, 0.22, 0.90, 0.55, 0.65, 0.85, 0.75, 2, 0, 0.10, 0.50, 0.48],
    'car':         [0.25, 0.25, 0.25, 0.25, 0.50, 0.55, 0.20, 0.80, 0.25, 1.50, 0.40, 0.85, 0.75, 0.60, 2, 2, 0.05, 0.50, 0.55],
    'boat':        [0.20, 0.20, 0.30, 0.30, 0.50, 0.60, 0.20, 0.80, 0.18, 1.40, 0.35, 0.85, 0.80, 0.50, 2, 0, 0.10, 0.50, 0.55],
    'umbrella':    [0.30, 0.30, 0.20, 0.20, 0.50, 0.40, 0.25, 0.75, 0.18, 0.80, 0.50, 0.80, 0.85, 0.40, 2, 0, 0.15, 0.50, 0.45],
    'cup':         [0.20, 0.20, 0.30, 0.30, 0.50, 0.55, 0.15, 0.85, 0.22, 0.80, 0.45, 0.90, 0.85, 0.50, 1, 0, 0.05, 0.50, 0.55],
    'key':         [0.30, 0.20, 0.30, 0.20, 0.45, 0.50, 0.25, 0.75, 0.12, 0.50, 0.30, 0.70, 0.60, 0.50, 1, 1, 0.20, 0.45, 0.50],
    'cat':         [0.28, 0.28, 0.22, 0.22, 0.50, 0.42, 0.25, 0.75, 0.22, 0.80, 0.50, 0.75, 0.80, 0.45, 2, 0, 0.15, 0.50, 0.45],
    'fish':        [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.25, 0.75, 0.25, 1.50, 0.55, 0.85, 0.70, 0.80, 1, 0, 0.10, 0.50, 0.50],
    'bird':        [0.30, 0.30, 0.20, 0.20, 0.50, 0.40, 0.20, 0.80, 0.15, 1.30, 0.40, 0.70, 0.70, 0.40, 2, 0, 0.20, 0.50, 0.42],
    'snake':       [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.35, 0.65, 0.10, 0.40, 0.15, 0.50, 0.40, 0.40, 1, 0, 0.50, 0.50, 0.50],
    'butterfly':   [0.25, 0.25, 0.25, 0.25, 0.50, 0.48, 0.25, 0.75, 0.22, 1.10, 0.50, 0.65, 0.90, 0.60, 2, 0, 0.10, 0.50, 0.48],
    'spider':      [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.35, 0.65, 0.18, 1.00, 0.35, 0.50, 0.85, 0.80, 3, 0, 0.60, 0.50, 0.50],
    'rabbit':      [0.28, 0.28, 0.22, 0.22, 0.50, 0.42, 0.25, 0.75, 0.20, 0.70, 0.45, 0.75, 0.80, 0.40, 2, 0, 0.15, 0.50, 0.42],
    'lightning':   [0.30, 0.20, 0.20, 0.30, 0.45, 0.50, 0.35, 0.65, 0.10, 0.50, 0.10, 0.80, 0.30, 0.40, 1, 0, 0.80, 0.48, 0.50],
    'spiral':      [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.40, 0.60, 0.15, 1.00, 0.80, 0.50, 0.70, 0.70, 1, 0, 0.30, 0.50, 0.50],
    'mountain':    [0.30, 0.30, 0.20, 0.20, 0.50, 0.35, 0.25, 0.75, 0.18, 1.30, 0.25, 0.90, 0.75, 0.30, 1, 0, 0.10, 0.50, 0.40],
    'cloud':       [0.25, 0.25, 0.25, 0.25, 0.50, 0.45, 0.20, 0.80, 0.25, 1.40, 0.70, 0.80, 0.80, 0.75, 1, 0, 0.00, 0.50, 0.47],
    'eye':         [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.35, 0.65, 0.20, 1.60, 0.60, 0.85, 0.85, 0.85, 2, 1, 0.00, 0.50, 0.50],
    'sword':       [0.25, 0.25, 0.25, 0.25, 0.50, 0.50, 0.30, 0.70, 0.10, 0.30, 0.10, 0.90, 0.80, 0.50, 2, 0, 0.30, 0.50, 0.50],
    'skull':       [0.28, 0.28, 0.22, 0.22, 0.50, 0.45, 0.25, 0.75, 0.25, 0.85, 0.70, 0.80, 0.90, 0.55, 2, 2, 0.05, 0.50, 0.47],
    'crown':       [0.30, 0.30, 0.20, 0.20, 0.50, 0.40, 0.22, 0.78, 0.20, 1.40, 0.35, 0.75, 0.85, 0.35, 1, 0, 0.15, 0.50, 0.42],
    'rocket':      [0.28, 0.28, 0.22, 0.22, 0.50, 0.42, 0.30, 0.70, 0.15, 0.50, 0.35, 0.85, 0.85, 0.40, 2, 0, 0.10, 0.50, 0.45],
    'music note':  [0.30, 0.20, 0.20, 0.30, 0.45, 0.48, 0.30, 0.70, 0.10, 0.60, 0.30, 0.70, 0.40, 0.40, 2, 1, 0.20, 0.47, 0.48],
  };

  /* Feature weights for weighted cosine similarity */
  const FEATURE_WEIGHTS = [
    2.0, 2.0, 2.0, 2.0,  // quadrant densities
    1.5, 1.5,              // balance H, V
    1.8, 1.8,              // center density, edge density
    2.5,                   // fill ratio
    2.0,                   // aspect ratio
    2.5,                   // circularity
    1.5,                   // convexity
    2.0, 2.0,              // symmetry H, V
    1.0,                   // stroke count
    1.5,                   // hole count
    1.2,                   // endpoint ratio
    1.0, 1.0,              // centroid X, Y
  ];
  ...
  function extractFeatures(grid) {
    ...
    return [
      ...
      symmetryH, symmetryV,
      Math.min(5, strokeCount),
      Math.min(5, holeCount),
